                          ...
                          >
                            ...
                            >
                              <v-card-title>
                                ...
                                <p class="ml-5">{{ data.postData.fullname }}</p>
                                <v-spacer></v-spacer>
                                ...
                                <v-menu bottom left>
                                  ...
                                  <v-list>
                                    <v-list-item>
                                      <v-list-item-title><button @click="reportPost(data.postData.id)"><v-icon color="red">mdi-alert</v-icon> Report</button></v-list-item-title>
                                    </v-list-item>
                                    <v-list-item>
                                      <v-list-item-title><button @click="goToShowPost(data.postData.id)"><v-icon color="blue">mdi-page-next</v-icon> Go to Original Post</button></v-list-item-title>
                                    </v-list-item>
                                  </v-list>
                                </v-menu>
                              </v-card-title>
                            ...
                            >
                              <v-card-title>
                                ...
                                <p class="ml-3">{{ data.postData.fullname }}</p>
                                <v-spacer></v-spacer>
                                <v-menu bottom left>
                                  <template v-slot:activator="{ on, attrs }">
                                    <v-btn dark icon v-bind="attrs" v-on="on">
